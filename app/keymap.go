...
var Keymaps = KeymapSystem{
	Groups: map[string]Map{
		...
		TableGroup: {
			...
			// Tabs
			Bind{Key: Key{Code: tcell.KeyBacktab}, Cmd: cmd.TabPrev, Description: "Switch to previous tab"},
			Bind{Key: Key{Code: tcell.KeyTab}, Cmd: cmd.TabNext, Description: "Switch to next tab"},
